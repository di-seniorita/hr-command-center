...
async def send_to_llm_with_image(prompt: str, image_base64: str, max_tokens: int = 2048) -> str:
    """Отправляет prompt и изображение (base64) во внешний LLM-сервис.

    Используется для Vision-сценариев (например, распознавание фото резюме).
    """
